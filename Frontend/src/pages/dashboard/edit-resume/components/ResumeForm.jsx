...
function ResumeForm() {
  ...
  const sections = [
    { name: "Personal Details", icon: <User className="h-4 w-4" /> },
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-2">
          ...
          {currentIndex > 0 && (
            <Button
              size="sm"
              variant="outline"
              className="flex items-center gap-1 border-primary text-primary hover:bg-primary hover:text-white transition-colors duration-300"
          ...
          {currentIndex < 5 && (
            <Button
              size="sm"
              className="flex items-center gap-1 bg-gradient-to-r from-primary to-primary/80 hover:from-primary hover:to-primary/90 shadow-sm transition-all duration-300"
      ...
      {/* Section tabs - now in a pill-shaped container */}
      <div className="hidden sm:flex justify-center">
        <div className="bg-white rounded-full shadow-md p-1 border border-gray-100 flex">
          {sections.map((section, idx) => (
            ...
            >
              <div className={`flex items-center justify-center h-5 w-5 rounded-full ${
                currentIndex === idx ? "bg-white text-primary" : "bg-gray-100"
              }`}>
                {idx + 1}
              </div>
      ...
      <div className="flex justify-between mt-6 sm:hidden bg-white p-4 rounded-lg shadow-md fixed bottom-0 left-0 right-0 z-10 border-t border-gray-100">
        ...
        {currentIndex < 5 && (
          <Button
            size="sm"
            className="flex items-center gap-1 bg-gradient-to-r from-primary to-primary/80"
            disabled={!enanbledNext}
            onClick={() => {
              if (currentIndex >= 5) return;
              setCurrentIndex(currentIndex + 1);
